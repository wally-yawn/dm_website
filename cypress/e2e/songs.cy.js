describe('songs', () => {
  ...
  it('displays displays all songs', () => {
    ...
    cy.get('.container > :nth-child(1) > ul > li').should('have.length', 3)
    ...
    cy.get('.container > :nth-child(1) > ul > :nth-child(3) a').should('have.attr', 'href', 'https://amazon.com/music/player/tracks/B01LEGNP7S?marketplaceId=ATVPDKIKX0DER&musicTerritory=US&ref=dm_sh_wLOW21UrnCqIkIeqIIxJZ0p0H')
  })
})