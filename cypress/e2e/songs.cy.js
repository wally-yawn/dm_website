describe('navigation', () => {
  ...
  it('displays displays all songs', () => {
    ...
    cy.get('.container > :nth-child(1) > ul').should('have.length', 1)
    cy.get('.container > :nth-child(1) > ul > :nth-child(1').should('have.attr', 'href', 'https://open.spotify.com/track/0pPuFEhR6k9Fpu1zGCjpVz?si=e31ef71857154177')
  })
})